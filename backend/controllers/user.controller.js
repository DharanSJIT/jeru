...
const putData = async (req, res) => {
    try {
        ...
        // If the profile is marked as completed or they explicitly submitted
        // We trigger the matching engine
        let matchesData = {};
        if (req.body.hasCompletedProfile) {
            matchesData = await generateMatchesForUser(userId);
        }
        ...
        return res.status(200).json({
            ...
            roadmap: matchesData.roadmap || null,
