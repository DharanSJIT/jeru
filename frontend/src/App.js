        ...
        <BrowserRouter>
            <UserProvider>
                <div className="App">
                    ...
                    <a
                        href="#main-content"
                        className="sr-only focus:not-sr-only focus:fixed focus:top-3 focus:left-3 focus:z-[60] focus:bg-brand focus:text-white focus:px-5 focus:py-2.5 focus:rounded-full focus:font-body focus:text-sm"
                    >
                    ...
                    {/* CONTENT */}
                    <main id="main-content" className="content-wrapper pt-[5rem]">
                        <Routes>
