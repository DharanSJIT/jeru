                ...
                if (content.length) {
                    return (
                        <div key={index} className="mb-3">
                            <div className="font-semibold text-[#0052CC]">{title.trim()}:</div>
                            <div className="pl-3">
        ...
        <div className="fixed bottom-4 right-4 z-50">
            {!isOpen ? (
                <button
                    ...
                    className="bg-[#0052CC] text-white p-4 rounded-full shadow-lg hover:bg-[#003D99] transition-colors"
                >
                    ...
                    <div className="bg-[#0052CC] text-white p-4 rounded-t-lg flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-2">
                            <select
                                ...
                                className="bg-[#003D99] text-white p-1 rounded"
                            >
                            ...
                            <button
                                ...
                                className="hover:bg-[#003D99] p-1 rounded transition-colors"
                            >
                                <X size={20} />
                            </button>
                        </div>
                    ...
                    <form onSubmit={handleSubmit} className="p-4 border-t">
                        <div className="flex gap-2">
                            <input
                                ...
                                className="flex-1 p-2 border rounded-lg focus:outline-none focus:border-[#0052CC]"
                            />
                            <button
                                type="submit"
                                disabled={!input.trim() || isLoading}
                                className="bg-[#0052CC] text-white p-2 rounded-lg hover:bg-[#003D99] disabled:opacity-50"
                            >
                                <Send size={20} />
                            </button>
                        </div>
