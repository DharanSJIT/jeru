...
const theme = createTheme({
    palette: {
        primary: {
            main: "#0052CC", // Primary color
        },
        secondary: {
            main: "#2563EB", // Secondary color
        },
        background: {
            default: "#F8FAFC", // Background color
        },
    },
});
                        ...
                        <StyledForm noValidate onSubmit={handleSubmit}>
                            ...
                            <Box mt={2}>
                                <Typography variant="body2">
                                    ...
                                    <Link
                                        to="/login"
                                        className="text-brand font-semibold hover:text-brand-dark transition-colors duration-300 text-base">
                                        Sign In
                                    </Link>
                                </Typography>
                            </Box>
