                ...
                <div className="flex justify-between items-center mb-8">
                    ...
                    {!isEditing ? (
                        <button
                            ...
                            className="flex items-center text-[#0052CC] hover:text-[#003D99] transition-colors"
                        >
                ...
                {!isEditing ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex justify-end space-x-4 pt-6">
                            ...
                            <button
                                type="submit"
                                className="px-4 py-2 text-white bg-[#0052CC] rounded-lg hover:bg-[#003D99] transition-colors flex items-center"
                            >
